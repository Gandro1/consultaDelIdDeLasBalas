...
/*    */ {
/* 32 */   private static final Marker MARKER = MarkerManager.getMarker("AllowAttachmentTagsLoader");
/* 33 */   private static final Pattern TAGS_PATTERN = Pattern.compile("^(\\w+)/tags/attachments/allow_attachments/(\\w+)\\.json$");
/*    */   
...
/* 49 */           CommonGunPackNetwork.addData(DataType.ALLOW_ATTACHMENT_TAGS, registryName, json);
...
/* 60 */     Path filePath = root.toPath().resolve("tags/attachments/allow_attachments");
/* 61 */     if (Files.isDirectory(filePath, new java.nio.file.LinkOption[0])) {
/* 62 */       TacPathVisitor visitor = new TacPathVisitor(filePath.toFile(), root.getName(), ".json", (id, file) -> { try { InputStream stream = Files.newInputStream(file, new java.nio.file.OpenOption[0]); try { String json = IOUtils.toString(stream, StandardCharsets.UTF_8); loadFromJsonString(id, json); CommonGunPackNetwork.addData(DataType.ALLOW_ATTACHMENT_TAGS, id, json); if (stream != null)
...
/*    */       );
/* 84 */     CommonAssetManager.INSTANCE.putAllowAttachmentTags(id, tags);
/*    */   }
/*    */ }


/* Location:              C:\Users\gabri\AppData\Roaming\.minecraft\mods\tacz-1.20.1-1.0.3-all.jar!\com\tacz\guns\resource\loader\asset\AllowAttachmentTagsLoader.class
